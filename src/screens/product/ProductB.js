...
import {Caption, Heading5, SmallText} from '../../component/text/CustomText';
    ...
    return (
      ...
      <SafeAreaView style={{flex: 1}}>
        ...
        <SelectMultiple
          ...
          selectedCheckboxStyle={styles.filledIndicator}
          checkboxStyle={styles.emptyIndicator}
          items={fruits}
